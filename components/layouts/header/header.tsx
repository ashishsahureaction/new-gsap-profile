...
const MainHeader = () => {
  ...
  return (
    ...
    >
      ...
      >
        <ul
          className={`items-center flex gap-base px-base justify-center bg-[#ffffff]  duration-300 w-fit py-2 rounded-xl border-2 border-ash-black`}
        >
              ...
              <li key={index} className="group relative overflow-hidden">
                <button
                  className={`  items-center px-4 py-1 rounded-xl font-bold capitalize flex flex-col text-fluid-body-lg  group-hover:scale-[0.7] group-hover:opacity-50 duration-300 ${
                    pathname === headerItem.href ? "" : "text-ash-black"
                  }`}
                >
                  {headerItem.label}
                </button>
                <button
                  ...
                  className={`bg-ash-dark-grey items-center px-4 py-1 rounded-xl  font-bold capitalize flex flex-col text-ash-white text-fluid-body-lg  absolute left-0 group-hover:bottom-0 duration-300  
