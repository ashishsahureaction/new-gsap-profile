...
const HomepageValue = () => {
  ...
  return (
    <Section className="bg-ash-dark-grey relative overflow-fit value_section">
      ...
      <Container>
        <div className="grid sm:grid-cols-2 h-full z-10">
          <div className="my-auto h-full col-span-1 flex justify-center items-center">
            <h2 className="text-fluid-display-xl font-bebas overflow-hidden text-center text-ash-white flex items-center justify-center flex-col leading-none">
              Let's bring your ideas into
              <div className="font-bold my-base w-1/2 overflow-hidden font-manrope text-ash-black bg-ash-yellow">
          ...
          <div className="w-full flex justify-center items-center relative">
            <button className="py-4 px-32 group bg-ash-ximen rounded-full relative overflow-hidden text-ash-white font-bebas text-fluid-body-xxl">
              <span className="bg-ash-yellow -bottom-96 right-0 rounded-full w-full h-full absolute group-hover:bottom-0 duration-150"></span>
              <span className="relative group-hover:text-ash-black duration-500">
                Let's go
              </span>
            </button>
          </div>
        </div>
        <div className="border-t text-ash-white z-10 mt-base border-ash-yellow py-base flex flex-col sm:flex-row gap-base justify-between items-center">
          <div>
            <p className="font-bebas">Made from Toronto Canada @</p>
          </div>
