        ...
        <Container>
          ...
          >
            <div className=" sm:col-span-4  text-ash-ximen text-center flex justify-center items-center flex-col">
              <h1 className="font-bebas text-ash-black text-fluid-display-3xl leading-none">
                Services
              </h1>
              <p className="font-bold text-ash-black font-manrope sm:w-5/6 w-full text-fluid-body-xxl text-center">
