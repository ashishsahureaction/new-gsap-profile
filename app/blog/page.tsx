...
const BlogPage = () => {
  return (
    <main className="rounded-3xl relative no-scrollbar overflow-y-hidden">
      <Section className="bg-ash-white">
        <Container>
          <div className="w-full justify-center items-center flex flex-col my-xl">
            <h1 className="text-fluid-display-2xl text-ash-ximen font-bebas leading-none">
              Blog
            </h1>
          ...
          <div className="h-screen -mb-xxl sm:h-full">
            <div className="h-full w-full relative flex justify-start items-end group overflow-hidden cursor-pointer">
              ...
              />
              <p className="absolute -top-24 text-ash-black text-fluid-body-xl font-bebas px-base bg-ash-white group-hover:top-0 duration-300">
                Latest Article
              </p>
              <div className="w-full bg-ash-black text-ash-white flex justify-around items-center relative -bottom-96 group-hover:bottom-0 duration-300">
                <h3 className="font-bebas font-bold text-fluid-display-m">
                  Blog 1
                </h3>
                <div className="flex gap-base items-center justify-center">
                  <p className="px-base bg-ash-ximen text-white py-xs">
                    Next JS
                  </p>
                  <p className="px-base bg-ash-ximen text-white py-xs">
                    React JS
      ...
      <div className="bg-ash-grey py-xxxl">
        <Container>
